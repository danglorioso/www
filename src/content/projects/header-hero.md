...
summary: "A Visual Studio Code extension that automatically generates customizable file headers with smart templates that extract metadata from all files in a directory. Used by 100+ users."
